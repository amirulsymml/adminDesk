            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <div class="row row-deck row-cards my-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mt-1">
                            <input type="text" name="name" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Priority Name" autocomplete="off" value="{{ old('name') }}">
                        </div>
                        @error('name')
