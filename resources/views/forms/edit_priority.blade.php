                                ...
                                <div class="overflow-x-auto">
                                    <form action="{{ route('admin.priorities.update', $priority->id) }}" method="post" autocomplete="off" novalidate>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="mt-1">
                                                <input type="text" name="name" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Priority Name" autocomplete="off" value="{{ old('name', $priority->name) }}">
                                            </div>
                                            @error('name')
