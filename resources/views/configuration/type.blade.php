        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Types</h1>
                        <p class="text-sm text-gray-600 mt-1">Manage and track support tickets efficiently</p>
                    </div>
                    <button type="button" onclick="window.location='{{ route('admin.types.create') }}'" class="btn btn-secondary">
                        Create New Type
                    </button>
                </div>
                                    ...
                                    <table class="table table-vcenter table-mobile-md card-table">
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            ...
                                            <tr class="hover:bg-gray-50">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $type->slug }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $type->created_at->format('M d, Y') }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    <div class="flex items-center space-x-2">
                                                        <a href="{{ route('admin.types.edit', $type->id) }}" class="text-indigo-600 hover:text-indigo-900 px-2 py-1 rounded hover:bg-indigo-50 transition-colors">Edit</a>
